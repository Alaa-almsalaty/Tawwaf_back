...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('hotels', function (Blueprint $table) {
            ...
            $table->string('city', 100)->nullable(); // City where the hotel is located
            $table->string('phone', 20)->nullable(); // Phone number of the hotel
            $table->integer('capacity')->nullable();
            $table->integer('rooms_count')->nullable();// Number of rooms in the hotel
            $table->enum('stars', ['one', 'two', 'three', 'four', 'five' , 'six' , 'seven'])->nullable()->default('one'); // Hotel rating in stars, default is one star
            $table->decimal('distance_from_center', 8, 2)->nullable()->default(0.00); // Distance from the city center in meters
